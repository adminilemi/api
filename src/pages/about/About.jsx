      ...
      <div>
        ...
        <div className='everyone-deserves-main-div'>
          ...
          <div className='everyone-right-text-div'>
            ...
            <p>
              ...
              of finding that perfect home a reality for everyone. At the core
              of this belief is the understanding that home is more than just a
              physical space; it's a haven where memories are created, dreams
              take root, and life unfolds. Regardless of background or
              circumstance, the right to a home that resonates with one's heart
              is a fundamental human need. It's a place where individuals find
              solace, belonging, and the freedom to express their unique
              identity. Creating spaces that inspire love and joy contributes to
              a richer, more inclusive world for all.
            </p>
          </div>
        </div>
        <div className='crafting-div'>
          <div className='crafting-left-text'>
            ...
            <p>
              Our real estate experience is designed to eliminate hurdles and
              make every step effortless for you.
            </p>
          </div>
        ...
        <div className='creating-change'>
          ...
          <div className='creating-change-text-div'>
            ...
            <p>
              We hold the belief that homes are fundamental to life. Utilizing
              our platform and influence in the housing sector, we initiate
